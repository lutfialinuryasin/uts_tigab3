...
define('HEADER_TITLE_CART_CONTENTS', 'Isi Keranjang');
...
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Alamat Email Anda telah digunakan - Silahkan masuk dengan Email  tersebut atau buat akun baru dengan Email lain.');
...
define('ENTRY_TELEPHONE_NUMBER_ERROR', 'No Telepon  minimal ' . ENTRY_TELEPHONE_MIN_LENGTH . ' Angka.');
...
define('IMAGE_BUTTON_CHANGE_ADDRESS', 'Ganti Alamat');
...
define('IMAGE_BUTTON_CONTINUE_SHOPPING', 'Lanjut Belanja');
define('IMAGE_BUTTON_DELETE', 'Hapus');
define('IMAGE_BUTTON_EDIT_ACCOUNT', 'Rubah Akun');
define('IMAGE_BUTTON_HISTORY', 'Sejarah Pemesanan');
define('IMAGE_BUTTON_LOGIN', 'Masuk');
define('IMAGE_BUTTON_IN_CART', 'Tambah Keranjang');
...
define('IMAGE_BUTTON_REVIEWS', 'Lihat');
...
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>Jika Anda bukan  %s, silahkan <a href="%s"><u>masuk</u></a> dengan akun Anda.</small>');
define('TEXT_GREETING_GUEST', 'Selamat Datang <span class="greetUser">Konsumen!</span> Apakah anda ingin <a href="%s"><u>masuk</u></a>? Atau memilih <a href="%s"><u>membuat akun</u></a>?');
...
define('HEADER_TITLE_TOP', 'Beranda');
define('HEADER_TITLE_CATALOG', '<span class="greetUser">KATALOG!</span>');
define('HEADER_TITLE_LOGOFF', 'Keluar');
define('HEADER_TITLE_LOGIN', 'Masuk');
define('BOX_HEADING_SPECIALS', 'Spesial');
define("BOX_HEADING_WHATS_NEW", "Produk Baru ?");
define('BOX_HEADING_SEARCH', 'Cari di situs...');
define('BOX_HEADING_CURRENCIES', 'Mata Uang');
define('BOX_INFORMATION_CONTACT', 'Hubungi Kami');
define('BOX_SEARCH_ADVANCED_SEARCH', 'Pencarian Lanjut');
define('BOX_HEADING_REVIEWS', 'Lihat');
define('HEADER_TITLE_CART_CONTENTS', 'Isi Keranjang');
define('BOX_HEADING_SHOPPING_CART', 'Isi Keranjang');
define('BOX_SHOPPING_CART_NO_EMPTY', 'Keranjang Kosong!');
define('BOX_SHOPPING_CART_EMPTY', ' Item');
define('ENTRY_SEND', 'Kirim');
define('NO_ITEM', 'Kosong');
define('TEXT_CURRENT_SORT_ORDER', 'Urutan saat ini');
define('IMAGE_BUTTON_SORT_ORDER', 'Urutan');
define('ENTRY_NAME_ERROR', 'Nama anda harus berisi minimal ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' huruf.');
define('ENTRY_SECURIMAGECODE', 'Untuk mencegah spam,<br />silahkan masukkan: 2+2');
define('ENTRY_SECURIMAGECODE_ERROR', 'Incorrect: 2+2 = ?');
define('CLICK_TO_VIEW', 'Klik untuk melihat produk');
define('MATC_CONDITION_AGREEMENT', 'Saya telah membaca <a href="%s" target="_blank"><strong><u>Terms &amp; Conditions</u></strong></a> dan saya setuju dengan mereka: ');
define('MATC_HEADING_CONDITIONS', 'Syarat dan Ketentuan');
define('MATC_ERROR', 'Anda harus menyetujui syarat dan ketentuan kami untuk melanjutkan.');
define('TEXT_PASSWORD_FORGOTTEN', 'Lupa Password? Klik di sini.');
define('MODULE_BOXES_NEWSLETTER_TEXT', 'Mendaftar newsletter kami');
